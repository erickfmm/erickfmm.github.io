...
\input{sections/08-dashai-plugin}
...
\input{appendices/annex-9-mhc}
\input{appendices/annex-10-attnres}
\input{appendices/annex-11-vision}
\input{appendices/annex-12-positional-encodings}
\input{appendices/annex-13-ssog}
\input{appendices/annex-14-fast-weight}
